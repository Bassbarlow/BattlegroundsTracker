...
namespace BattlegroundTracker
{
    ...
    public class BgMatchData
    {
        ...
        public static TavernUpBttnManager _tavernUpBttnInput;
        public static RerollBttnManager _rerollInput;
        public static TavernUpBttnArea _tavernUp;
        public static TavernUpBttnArea _rerollArea;
        public static HashSet<Race> _avaiableTribes;
        public static Config _cfg = _config;
        ...
        internal static void AddOrRemoveTavernUpArea()
        {
            if (InBgMenu())
            {
