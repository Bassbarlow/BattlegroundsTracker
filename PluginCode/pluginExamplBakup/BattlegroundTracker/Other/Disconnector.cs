...
namespace BattlegroundTracker
{
    class Disconnector
    {
        ...
        public const string ruleName = @"Hearthstone_Disconnecter";
        ...
        public static void Disconnect()
        {
            ...
            RunCMD(@"/C netsh advfirewall firewall set rule name=""Hearthstone_Disconnecter"" new enable=yes");
        ...
        {
            RunCMD(@"/C netsh advfirewall firewall set rule name=""Hearthstone_Disconnecter"" new enable=no");
        }
    }
}
